...
public class PriceStrategy implements EnergyPrice {

    /**
     * Returns the production cost for the price strategy
     */
    @Override
    public int getProductionCost(int quantityKW, List<RelInfoProducer> producers, int id) {
        ...
        producers.sort((p1, p2) -> {
            ...
            if (p1.getPriceKW() > p2.getPriceKW()) {
                ...
                if ((p1.getPriceKW() == p2.getPriceKW()) && (p2.getEnergyPerDistributor()
    ...
    /**
     * Calculates the production cost for the price strategy
     */
    @Override
